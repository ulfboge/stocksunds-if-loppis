...
1. Skapa ett nytt repository på GitHub (t.ex. `stocksunds-if-loppis`)
...
5. Klicka **Save** – sidan är live på `https://[ditt-användarnamn].github.io/stocksunds-if-loppis/`
